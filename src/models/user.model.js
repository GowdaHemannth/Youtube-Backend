...
// will be wrtiing one more method to check the Generate the Access token
UserSchema.methods.GenerateAccessToken = function () {
  return jwt.sign(
    ...
    // Second aRGUMNET IS aCCESTKENsECRETKEY
...
// One More Same type Fucntion for Refresh TOKEN
